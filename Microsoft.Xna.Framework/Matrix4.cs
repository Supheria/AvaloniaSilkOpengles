...
namespace Microsoft.Xna.Framework
{
	...
	public struct Matrix4 : IEquatable<Matrix4>
	{
		...
		public static Matrix4 CreateTranslation(
			float xPosition,
			float yPosition,
			float zPosition
		) {
		...
		public static void Transform(
			...
			Matrix4 rotMatrix = CreateFromQuaternion(rotation);
		...
		{
			return Matrix4.Add(matrix1, matrix2);
		}
		...
		public static Matrix4 operator /(Matrix4 matrix1, Matrix4 matrix2)
		{
			return Matrix4.Divide(matrix1, matrix2);
		}
		...
		{
			return Matrix4.Divide(matrix, divider);
		}
