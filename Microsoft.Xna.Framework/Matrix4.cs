...
{ 
    ...
    public struct Matrix4 : IEquatable<Matrix4>
    {
        ...
        /// <param name="zFarPlane">Depth of the far plane.</param>
        /// <returns>The new projection <see cref="Matrix4"/> for customized orthographic view.</returns>
        public static Matrix4 CreateOrthographicOffCenter(Rectangle viewingVolume, float zNearPlane, float zFarPlane)
        {
            Matrix4 matrix;
        ...
        /// <param name="farPlaneDistance">Distance to the far plane.</param>
        /// <returns>The new <see cref="Matrix4"/> for customized perspective view.</returns>
        public static Matrix4 CreatePerspectiveOffCenter(Rectangle viewingVolume, float nearPlaneDistance, float farPlaneDistance)
        {
            Matrix4 result;
        ...
        /// <summary>
        /// Converts a <see cref="System.Numerics.Matrix4x4"/> to a <see cref="Matrix4"/>.
        /// </summary>
        /// <param name="value">The converted value.</param>
        public static implicit operator Matrix4(System.Numerics.Matrix4x4 value)
        {
            return new Matrix4(
