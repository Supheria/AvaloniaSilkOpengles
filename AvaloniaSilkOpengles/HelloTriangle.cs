...
void main()
{
    gl_Position = vec4(aPosition, 1.0);
        ...
        if (vStatus != (int)GLEnum.True)
            throw new Exception(
                "Vertex shader failed to compile: " + _gl.GetShaderInfoLog(vertexShader)
            );
...
void main()
{
    ...
    protected override unsafe void OnOpenGlRender(GlInterface gl, int fb)
    {
        ...
        _gl.Viewport(0, 0, (uint)(Bounds.Width * scaling), (uint)(Bounds.Height * scaling));
        _gl.UseProgram(_program);
        _gl.BindVertexArray(_vao);

        _gl.DrawElements(PrimitiveType.TriangleFan, 3, DrawElementsType.UnsignedInt, (void*)0);
    }
}
